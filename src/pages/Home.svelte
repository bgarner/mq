...
<div class="stage">
	...
	<div class="content">
		<h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl text-center">Welcome to Moroni's Quest</h1>
		...
		<p class="text-2xl mt-4 leading-6 font-medium text-gray-900 text-center">July 21 - 23, 2022</p>
				...
				<p class="text-center">
<iframe style="margin: 20px auto;" width="560" height="315" src="https://www.youtube.com/embed/qW3j9fuWM1I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</p>
...
Youth will watch and participate in reenactments of important scenes from the Book of Mormon. Follow-up discussions with tribe leaders will help us understand the scriptures better and apply them to our own lives and situations today.</p>
		<p class="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
Our faith and testimonies of the Book of Mormon and the Saviour will be strengthened as we experience the Book of Mormon in a brand-new way together.
		</p>
